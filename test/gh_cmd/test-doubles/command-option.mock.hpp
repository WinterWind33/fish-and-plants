...
public:
    ...
    MOCK_METHOD(void, acceptVisitor,
                (const ConstOptionVisitor<std::shared_ptr<const base_impl_type>>&),
                (const, noexcept, override));
    MOCK_METHOD(void, acceptVisitor, (OptionVisitor<std::shared_ptr<base_impl_type>>&),
                (noexcept, override));
