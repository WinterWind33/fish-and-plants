...
#ifdef USE_LIBGPIOD
[[nodiscard]] std::unique_ptr<BackendChipType> openChip(const std::filesystem::path& chipPath) {
...
bool BoardChipImpl::releaseRequest(
    std::vector<hardware_access::BoardDigitalPin::offset_type> offsets) noexcept {
