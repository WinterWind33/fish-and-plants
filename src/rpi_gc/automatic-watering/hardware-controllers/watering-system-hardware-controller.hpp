...
namespace rpi_gc::automatic_watering {
    ...
    public:
        ...
        virtual void setWaterValveDigitalOutputID(const digital_output_type::offset_type id) noexcept = 0;
        virtual void setWaterPumpDigitalOutputID(const digital_output_type::offset_type id) noexcept = 0;
    };
