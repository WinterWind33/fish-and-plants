...
public:
    [[nodiscard]] constexpr time_unit getWateringSystemActivationDuration()
        const noexcept override {
        return m_activationTime;
    }

    [[nodiscard]] constexpr time_unit getWateringSystemDeactivationDuration()
        const noexcept override {
        return m_deactivationTime;
    }

    [[nodiscard]] constexpr time_unit getPumpValveDeactivationTimeSeparation()
        const noexcept override {
    ...
    constexpr void setWateringSystemDeactivationDuration(
        const time_unit duration) noexcept override {
        m_deactivationTime = duration;
    }

    constexpr void setPumpValveDeactivationTimeSeparation(
        const time_unit duration) noexcept override {
...
private:
    ...
    time_unit m_pumpValveDeactivationTimeSeparation{
        DEFAULT_PUMP_VALVE_DEACTIVATION_TIME_SEPARATION};
};
