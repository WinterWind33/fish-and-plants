...
rm ../bin/rpi_gc*
cmake .. -DCOMPILE_AARCH64_ON_LINUX=True --toolchain "toolchains/aarch64-toolchain.cmake" -DCMAKE_TOOLCHAIN_FILE=$1 -DRPI_GC_BUILD_TESTS=OFF
...
rm -r -f ../src/third-party/libgpiod-*
rm ../bin/rpi_gc*
cmake .. --toolchain "toolchains/linux-toolchain.cmake" -DCMAKE_TOOLCHAIN_FILE=$1 -DRPI_GC_BUILD_TESTS=OFF
cmake --build . --target rpi_gc --config Release -j8
